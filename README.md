...
6.CELLS ARE LABELED TO CHECK DATA, ANALYSIS IS BELOW BOTH CODE AND REPORT GO IN ORDER OF INDIVIDUAL ANALYSIS OF CITIES, GROUP ANALYSIS, AND CROSS ANALYSIS.
